...
____
## УСТАНОВКА
**Обязательные условия:** версия Python у Вас должна быть не ниже 3.8.10 (проверить можно командой `python3 --version`), в противном случае Python нужно будет обновить командой `apt install python3`; а также должен быть установлен менеджер пакетов **pip** (установить его можно командой `apt install-python3-pip`).

<br>Установить комплект игр "Brain Games" можно, клонировав мой репозиторий командой:
```
git clone git@github.com:ACupOfWhiskey/python-project-lvl1.git
```
И набрав следующую команду в терминале Вашего компьютера:
```
