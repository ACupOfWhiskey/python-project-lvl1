...
Суть игры в том, что программой Вам будет представлено определенное число, и нужно будет определить, является ли оно четным или же нет. Для успешного завершения игры Вам нужно будет ответить правильно три раза подряд.
Чтобы запустить игру нужно набрать команду brain-even в терминале на Вашем компьютере.
